...
For every schema, different types of interfaces will be generated. That is because Strapi v5 does not always represent the data using the same structure.
...
All command parameters are **case sensitive** and can be written both in _camel case_ and in _kebab case_. You can see more about command parameters using the help:
